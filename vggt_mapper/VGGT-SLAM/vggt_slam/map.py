...
class GraphMap:
    ...
    def retrieve_best_score_frame(self, query_vector, current_submap_id, candidate_ids, ignore_last_submap=True):
        ...
        for candidate_id in candidate_ids:
            if candidate_id == current_submap_id:
                continue

            if ignore_last_submap and (candidate_id == current_submap_id-1):
                continue

            else:
                submap = self.submaps[candidate_id]
                ...
                if best_score < overall_best_score:
                    ...
                    overall_best_submap_id = candidate_id
